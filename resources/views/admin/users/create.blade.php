...
<div class="data-card" style="max-width: 600px;">
    <form action="{{ route('admin.users.store') }}" method="POST">
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <input type="text" name="name" value="{{ old('name') }}" placeholder="Masukkan nama lengkap" style="
                width: 100%;
                padding: 0.75rem;
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <input type="email" name="email" value="{{ old('email') }}" placeholder="Masukkan email" style="
                width: 100%;
                padding: 0.75rem;
                background: rgba(255, 255, 255, 0.05);
                border: 1px solid rgba(255, 255, 255, 0.1);
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <input type="text" name="phone" value="{{ old('phone') }}" placeholder="Masukkan nomor telepon" style="
                width: 100%;
                padding: 0.75rem;
                background: rgba(255, 255, 255, 0.05);
                border: 1px solid rgba(255, 255, 255, 0.1);
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <textarea name="address" placeholder="Masukkan alamat" style="
                ...
                resize: vertical;
                min-height: 100px;
            " onfocus="this.style.borderColor='#6366f1'; this.style.boxShadow='0 0 0 3px rgba(99, 102, 241, 0.1)'" onblur="this.style.borderColor='rgba(255, 255, 255, 0.1)'; this.style.boxShadow='none'">{{ old('address') }}</textarea>
            @error('address')
                <p style="color: #f87171; font-size: 0.85rem; margin-top: 0.25rem;"><i class="bi bi-exclamation-circle"></i> {{ $message }}</p>
            @enderror
        </div>
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <input type="password" name="password" placeholder="Masukkan password (minimal 8 karakter)" style="
                width: 100%;
                padding: 0.75rem;
                background: rgba(255, 255, 255, 0.05);
                border: 1px solid rgba(255, 255, 255, 0.1);
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <input type="password" name="password_confirmation" placeholder="Konfirmasi password" style="
                width: 100%;
                padding: 0.75rem;
                background: rgba(255, 255, 255, 0.05);
                border: 1px solid rgba(255, 255, 255, 0.1);
        ...
        <div style="margin-bottom: 2rem;">
            <label style="display: flex; align-items: center; gap: 0.75rem; cursor: pointer;">
                <input type="checkbox" name="is_active" value="1" checked style="
                    width: 20px;
                    height: 20px;
                    cursor: pointer;
                    accent-color: #6366f1;
