...
<div style="padding: 2rem; min-height: calc(100vh - 80px);">
    <div style="max-width: 900px; margin: 0 auto;">
        ...
        <div style="margin-bottom: 2.5rem; text-align: center;">
            ...
            ">
                <i class="bi bi-plus-circle-fill" style="color: white; font-size: 2.5rem;"></i>
            </div>
            <h1 style="color: white; font-size: 2.5rem; font-weight: 700; margin: 0 0 0.75rem 0; background: linear-gradient(135deg, #fff 0%, #16a34a 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
                Tambah Service Baru
            </h1>
            <p style="color: rgba(255, 255, 255, 0.6); margin: 0; font-size: 1.05rem;">
                <i class="bi bi-leaf"></i> Lengkapi form untuk menambahkan layanan eco-friendly
            </p>
        </div>
        ...
        ">
            <!-- Decorative Elements -->
            <div style="position: absolute; top: -100px; right: -100px; width: 250px; height: 250px; background: radial-gradient(circle, rgba(34, 197, 94, 0.15) 0%, transparent 70%); border-radius: 50%;"></div>
            <div style="position: absolute; bottom: -80px; left: -80px; width: 200px; height: 200px; background: radial-gradient(circle, rgba(22, 163, 74, 0.15) 0%, transparent 70%); border-radius: 50%;"></div>

            <form action="{{ route('admin.services.store') }}" method="POST" style="position: relative; z-index: 1;">
                @csrf
                ...
                <div style="margin-bottom: 2rem;">
                    <label style="
                        ...
                        gap: 0.5rem;
                    ">
                        <i class="bi bi-tag-fill" style="color: #16a34a;"></i>
                    ...
                    <div style="position: relative;">
                        ...
                        " onfocus="this.style.borderColor='#16a34a'; this.style.background='rgba(34, 197, 94, 0.1)'; this.style.transform='scale(1.01)'; this.style.boxShadow='0 0 0 3px rgba(34, 197, 94, 0.15)'" onblur="this.style.borderColor='{{ $errors->has('name') ? '#ef4444' : 'rgba(34, 197, 94, 0.3)' }}'; this.style.background='rgba(10, 31, 10, 0.5)'; this.style.transform='scale(1)'; this.style.boxShadow='none'" placeholder="Contoh: Green Wash Premium">
                        <i class="bi bi-droplet-fill" style="position: absolute; left: 1rem; top: 50%; transform: translateY(-50%); color: rgba(34, 197, 94, 0.5); font-size: 1.1rem;"></i>
                    </div>
                    @error('name')
                ...
                <div style="margin-bottom: 2rem;">
                    <label style="
                        ...
                        gap: 0.5rem;
                    ">
                        <i class="bi bi-file-text-fill" style="color: #16a34a;"></i>
                        Deskripsi
                    </label>
                    <textarea name="description" rows="4" id="description" maxlength="200" style="
                        ...
                        font-family: inherit;
                        box-sizing: border-box;
                    " onfocus="this.style.borderColor='#16a34a'; this.style.background='rgba(34, 197, 94, 0.1)'; this.style.boxShadow='0 0 0 3px rgba(34, 197, 94, 0.15)'" onblur="this.style.borderColor='{{ $errors->has('description') ? '#ef4444' : 'rgba(34, 197, 94, 0.3)' }}'; this.style.background='rgba(10, 31, 10, 0.5)'; this.style.boxShadow='none'" oninput="updateCharCount()" placeholder="Deskripsikan layanan eco-friendly Anda...">{{ old('description') }}</textarea>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 2rem;">
                    ...
                    <div>
                        ...
                        <div style="position: relative;">
                            ...
                            <input type="number" name="price" value="{{ old('price') }}" required min="0" step="1000" style="
                                width: 100%;
                    ...
                    <div>
                        <label style="
                            ...
                            gap: 0.5rem;
                        ">
                            <i class="bi bi-rulers" style="color: #16a34a;"></i>
                        ...
                        <select name="unit" required style="
                            ...
                            box-sizing: border-box;
                            cursor: pointer;
                        " onfocus="this.style.borderColor='#16a34a'; this.style.background='rgba(34, 197, 94, 0.1)'; this.style.transform='scale(1.01)'; this.style.boxShadow='0 0 0 3px rgba(34, 197, 94, 0.15)'" onblur="this.style.borderColor='{{ $errors->has('unit') ? '#ef4444' : 'rgba(34, 197, 94, 0.3)' }}'; this.style.background='rgba(10, 31, 10, 0.5)'; this.style.transform='scale(1)'; this.style.boxShadow='none'">
                            <option value="" style="background: #0a1f0a;">Pilih Unit</option>
                            <option value="kg" {{ old('unit') == 'kg' ? 'selected' : '' }} style="background: #0a1f0a;">📦 Kilogram (kg)</option>
                            <option value="pcs" {{ old('unit') == 'pcs' ? 'selected' : '' }} style="background: #0a1f0a;">👕 Pieces (pcs)</option>
                            <option value="paket" {{ old('unit') == 'paket' ? 'selected' : '' }} style="background: #0a1f0a;">🎁 Paket</option>
                        </select>
                        @error('unit')
                        <span style="color: #ef4444; font-size: 0.875rem; margin-top: 0.5rem; display: flex; align-items: center; gap: 0.25rem;">
                            <i class="bi bi-exclamation-circle-fill"></i> {{ $message }}
                    ...
                    ">
                        <div style="display: flex; align-items: center; gap: 1rem;">
                            ...
                            <div>
                                ...
                                <span style="color: rgba(255, 255, 255, 0.6); font-size: 0.875rem;">Aktifkan service eco-friendly setelah dibuat</span>
                            </div>
                        </div>
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} style="
                            width: 24px;
                            height: 24px;
                            cursor: pointer;
                            accent-color: #22c55e;
                ...
                <div style="display: flex; gap: 1rem; justify-content: flex-end; padding-top: 1rem; border-top: 1px solid rgba(34, 197, 94, 0.2);">
                    ...
                    <button type="submit" style="
                        ...
                        gap: 0.5rem;
                        font-size: 1rem;
                    " onmouseover="this.style.transform='translateY(-3px)'; this.style.boxShadow='0 12px 35px rgba(34, 197, 94, 0.6)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 8px 25px rgba(34, 197, 94, 0.4)'">
