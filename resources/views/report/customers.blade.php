            ...
            <table style="width: 100%; border-collapse: collapse;">
                <thead style="background: #f9fafb; border-bottom: 2px solid #e5e7eb;">
                    <tr>
                        ...
                        <th style="padding: 1rem; text-align: center; font-weight: 600; color: #374151; font-size: 0.875rem;">Items</th>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid #e5e7eb; transition: background 0.2s;"
                        ...
                        <td style="padding: 1rem; text-align: center;">
                            <span style="display: inline-block; padding: 0.25rem 0.625rem; background: #dbeafe; color: #1e40af; border-radius: 9999px; font-weight: 600; font-size: 0.75rem;">
                        ...
                        <td style="padding: 1rem; text-align: center;">
                            @php
                                $statusConfig = [
                                    ...
                                    'picked_up' => ['bg' => '#e9d5ff', 'color' => '#6b21a8', 'text' => 'Picked Up'],
                                    'cancelled' => ['bg' => '#fee2e2', 'color' => '#991b1b', 'text' => 'Cancelled'],
                                ];
                                $config = $statusConfig[$order->status] ?? ['bg' => '#f3f4f6', 'color' => '#374151', 'text' => $order->status];
                            @endphp
                        ...
                        <td style="padding: 1rem; text-align: right; font-weight: 600; color: #1f2937; font-size: 0.875rem;">
